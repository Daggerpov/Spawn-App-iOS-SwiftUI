...
class FriendshipCacheService: BaseCacheService, CacheService, ObservableObject {
    ...
    func getCurrentUserFriendRequests() -> [FetchFriendRequestDTO] {
        ...
        print("📦 [FRIENDSHIP-CACHE] getCurrentUserFriendRequests returned \(requests.count) requests for user \(userId)")
        return requests
    }
    ...
    func updateFriendRequestsForUser(_ newFriendRequests: [FetchFriendRequestDTO], userId: UUID) {
        print("💾 [FRIENDSHIP-CACHE] Updating incoming friend requests cache for user \(userId): \(newFriendRequests.count) requests")
    ...
    func getCurrentUserSentFriendRequests() -> [FetchSentFriendRequestDTO] {
        ...
        print("📦 [FRIENDSHIP-CACHE] getCurrentUserSentFriendRequests returned \(requests.count) requests for user \(userId)")
        return requests
    }
    ...
    func updateSentFriendRequestsForUser(_ newSentFriendRequests: [FetchSentFriendRequestDTO], userId: UUID) {
        print("💾 [FRIENDSHIP-CACHE] Updating sent friend requests cache for user \(userId): \(newSentFriendRequests.count) requests")
