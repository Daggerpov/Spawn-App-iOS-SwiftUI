...
protocol IAPIService {
    ...
    func sendData<T: Encodable>(_ object: T, to url: URL, parameters: [String: AnyObject]?) async throws -> T where T: Decodable
	/// generic function for updating (PUTting) data, given a model of type, T, and returning the updated object
	func updateData<T: Encodable, U: Decodable>(_ object: T, to url: URL, parameters: [String: String]?) async throws -> U
