...
struct ActivityCardTopRowView: View {
	...
	init(
		activity: FullFeedActivityDTO, selectedTab: Binding<TabType?> = .constant(nil), locationManager: LocationManager
	) {
...
#Preview {
	...
	ActivityCardTopRowView(activity: FullFeedActivityDTO.mockDinnerActivity, locationManager: LocationManager.shared)
